...
from deit_encoder import DeiTMedicalEncoder  # Changed from image_encoder
...
caption_lstm = CaptionLSTM(hidden_size=1024, num_layers=2, img_feature_size=768).to(device)  # Updated for 768-dim inputs
...
# Scheduler
warmup_epochs = 3
num_epochs = 10  # Modified epoch count for memory constraints
def lr_lambda(epoch):
